    ...
    <div class="card">
      ...
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <input name="music_api_key" type="password" placeholder="{'Currently set ✅ — paste to update' if music_api_key else 'Leave blank to use iTunes (free)'}" value="">
          {'<p style="font-size:11px;color:var(--accent);margin-top:4px">✅ Key is set: ' + mask_key(music_api_key) + '</p>' if music_api_key else '<p style="font-size:11px;color:var(--muted);margin-top:4px">Optional — bot uses iTunes Search API (free, no key) by default</p>'}
